...
{
  float bfuncs[4];
  int i = get_NUBasis_funcs_c (spline->x_basis, x, bfuncs);
			...
			complex_float* restrict val, complex_float* restrict grad)
{
  ...
  int i = get_NUBasis_dfuncs_c (spline->x_basis, x, bfuncs, dbfuncs);
  complex_float* restrict coefs = spline->coefs;
  *val =  (coefs[i+0]* bfuncs[0] + coefs[i+1]* bfuncs[1] +
	   coefs[i+2]* bfuncs[2] + coefs[i+3]* bfuncs[3]);
			...
			complex_float* restrict lapl)
{
  ...
  int i = get_NUBasis_d2funcs_c (spline->x_basis, x, bfuncs, dbfuncs, d2bfuncs);
  complex_float* restrict coefs = spline->coefs;
  *val =  (coefs[i+0]*  bfuncs[0] + coefs[i+1]*  bfuncs[1] +
	   coefs[i+2]*  bfuncs[2] + coefs[i+3]*  bfuncs[3]);
  *grad = (coefs[i+0]* dbfuncs[0] + coefs[i+1]* dbfuncs[1] +
...
{
  float a[4], b[4];
  int ix = get_NUBasis_funcs_c (spline->x_basis, x, a);
  int iy = get_NUBasis_funcs_c (spline->y_basis, y, b);
		       ...
		       complex_float* restrict val, complex_float* restrict grad)
{
  ...
  int ix = get_NUBasis_dfuncs_c (spline->x_basis, x, a, da);
  int iy = get_NUBasis_dfuncs_c (spline->y_basis, y, b, db);
			...
			complex_float* restrict grad, complex_float* restrict lapl)
{
  ...
  complex_float bc[4];
  int ix = get_NUBasis_d2funcs_c (spline->x_basis, x, a, da, d2a);
  int iy = get_NUBasis_d2funcs_c (spline->y_basis, y, b, db, d2b);
		    ...
		    complex_float* restrict val)
{
  ...
  int ix = get_NUBasis_funcs_c (spline->x_basis, x, a);
  int iy = get_NUBasis_funcs_c (spline->y_basis, y, b);
  int iz = get_NUBasis_funcs_c (spline->z_basis, z, c);
  complex_float* restrict coefs = spline->coefs;
			...
			complex_float* restrict val, complex_float* restrict grad)
{
  ...
  int ix = get_NUBasis_dfuncs_c (spline->x_basis, x, a, da);
  int iy = get_NUBasis_dfuncs_c (spline->y_basis, y, b, db);
  int iz = get_NUBasis_dfuncs_c (spline->z_basis, z, c, dc);
  complex_float* restrict coefs = spline->coefs;
			 ...
			 complex_float* restrict lapl)
{
  ...
  int ix = get_NUBasis_d2funcs_c (spline->x_basis, x, a, da, d2a);
  int iy = get_NUBasis_d2funcs_c (spline->y_basis, y, b, db, d2b);
  int iz = get_NUBasis_d2funcs_c (spline->z_basis, z, c, dc, d2c);
